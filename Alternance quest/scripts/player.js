export class Player {
    ...
    preload() {
        this.scene.load.spritesheet('player', '../scripts/assets/mc_player.png', { frameWidth: 32, frameHeight: 32});
        this.scene.load.audio('jump', '../scripts/skills/jumps.wav');
        this.scene.load.audio('dash', '../scripts/skills/dash.mp3');
    }
