export class Said {
    ...
    preload() {
        this.scene.load.spritesheet('said', '../scripts/assets/Said.png', { frameWidth: 32, frameHeight: 32});
    }
...
export class Nathan {
    ...
    preload() {
        this.scene.load.spritesheet('nathan', '../scripts/assets/nathan.png', { frameWidth: 32, frameHeight: 32});
    }
...
export class Dylan {
    ...
    preload() {
        this.scene.load.spritesheet('dylan', '../scripts/assets/dylan.png', { frameWidth: 32, frameHeight: 32});
    }
...
export class Tanguy {
    ...
    preload() {
        this.scene.load.spritesheet('tanguy', '../scripts/assets/tanguy.png', { frameWidth: 32, frameHeight: 32});
    }
