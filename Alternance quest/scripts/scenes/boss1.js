...
export class FullStackScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.spritesheet('1stRecruiter', '../scripts/assets/1stRecruiter.png', { frameWidth: 32, frameHeight: 32});

        this.load.audio('win', '../scripts/music/win.mp3');
        this.load.audio('lose', '../scripts/music/lose.mp3');
