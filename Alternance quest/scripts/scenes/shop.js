...
export class Shop extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('ground', '../scripts/assets/platform.png');
        this.load.image('portal', '../scripts/assets/portal.png');
        this.load.spritesheet('nathan', '../scripts/assets/nathan.png', { frameWidth: 32, frameHeight: 32});
        this.load.spritesheet('dylan', '../scripts/assets/dylan.png', { frameWidth: 32, frameHeight: 32});
        this.load.spritesheet('tanguy', '../scripts/assets/tanguy.png', { frameWidth: 32, frameHeight: 32});
